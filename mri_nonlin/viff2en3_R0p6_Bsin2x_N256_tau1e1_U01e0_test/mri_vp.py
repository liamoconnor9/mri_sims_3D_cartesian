...
slicepoints.add_task("integ(integ( (vx - integ(integ( vx, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="ke_x_perts")
slicepoints.add_task("integ(integ( (bx - integ(integ( bx, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="be_x_perts")

slicepoints.add_task("integ(integ( (vy - integ(integ( vy, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="ke_y_perts")
slicepoints.add_task("integ(integ( (by - integ(integ( by, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="be_y_perts")

slicepoints.add_task("integ(integ( (vz - integ(integ( vz, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="ke_z_perts")
slicepoints.add_task("integ(integ( (bz - integ(integ( bz, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="be_z_perts")
