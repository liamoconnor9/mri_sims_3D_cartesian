...
slicepoints.add_task("integ(integ( (vx - integ(integ( vx, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="vx_profs")
slicepoints.add_task("integ(integ( (bx - integ(integ( bx, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="bx_profs")
slicepoints.add_task("integ(integ( (vy - integ(integ( vy, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="vy_profs")
slicepoints.add_task("integ(integ( (by - integ(integ( by, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="by_profs")
slicepoints.add_task("integ(integ( (vz - integ(integ( vz, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="vz_profs")
slicepoints.add_task("integ(integ( (bz - integ(integ( bz, 'y'), 'z') / (Lx**2 * ar**2))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="bz_profs")
...
solver.stop_wall_time = 6.0*60.*60.
