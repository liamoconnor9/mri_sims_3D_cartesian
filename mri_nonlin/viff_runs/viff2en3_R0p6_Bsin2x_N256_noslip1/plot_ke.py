...
if __name__ == "__main__":
    ...
    if (plot):
        ...
        shave_ind = 10
        plt.plot(sim_times_ar[:-shave_ind], ke_ar[:-shave_ind], color='darkblue', label=r'$\langle |\mathbf{u}|^2 \rangle_{\mathcal{D}}$')
        plt.plot(sim_times_ar[:-shave_ind], ke_tot_ar[:-shave_ind], color='darkred', label=r'$\langle |\mathbf{u}|^2 \rangle_{\mathcal{D}}$ + Sx')
        plt.yscale('log')
        if (regress):
