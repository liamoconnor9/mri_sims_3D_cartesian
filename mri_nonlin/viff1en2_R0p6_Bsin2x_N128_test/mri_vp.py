...
def get_param_from_suffix(suffix, param_prefix, default_param):
    ...
    if (prefix_index == -1):
        logger.info("Parameter" + param_prefix + " value not provided in write suffix " + suffix)
        if (required):
            raise 
        else:
        ...
        try:
            ...
            logger.warning("Failed to parse parameter " + param_prefix + " from run suffix " + suffix)
            if (required):
                raise 
            else:
                return default_param            
...
N = get_param_from_suffix(run_suffix, "N", np.NaN)
...
slicepoints.add_task("interp(vx, y={})".format(4 * Lx), name="vx_midy")
slicepoints.add_task("interp(vx, z={})".format(4 * Lx), name="vx_midz")
slicepoints.add_task("interp(vx, x={})".format(0.0), name="vx_midx")

slicepoints.add_task("interp(vy, y={})".format(4 * Lx), name="vy_midy")
slicepoints.add_task("interp(vy, z={})".format(4 * Lx), name="vy_midz")
slicepoints.add_task("interp(vy, x={})".format(0.0), name="vy_midx")

slicepoints.add_task("interp(vz, y={})".format(4 * Lx), name="vz_midy")
slicepoints.add_task("interp(vz, z={})".format(4 * Lx), name="vz_midz")
slicepoints.add_task("interp(vz, x={})".format(0.0), name="vz_midx")

slicepoints.add_task("interp(bx, y={})".format(4 * Lx), name="bx_midy")
slicepoints.add_task("interp(bx, z={})".format(4 * Lx), name="bx_midz")
slicepoints.add_task("interp(bx, x={})".format(0.0), name="bx_midx")

slicepoints.add_task("interp(by, y={})".format(4 * Lx), name="by_midy")
slicepoints.add_task("interp(by, z={})".format(4 * Lx), name="by_midz")
slicepoints.add_task("interp(by, x={})".format(0.0), name="by_midx")

slicepoints.add_task("interp(bz, y={})".format(4 * Lx), name="bz_midy")
slicepoints.add_task("interp(bz, z={})".format(4 * Lx), name="bz_midz")
...
slicepoints.add_task("integ(integ( (vx - integ(integ( vx, 'y'), 'z'))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="ke_x_perts")
slicepoints.add_task("integ(integ( (bx - integ(integ( bx, 'y'), 'z'))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="be_x_perts")

slicepoints.add_task("integ(integ( (vy - integ(integ( vy, 'y'), 'z'))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="ke_y_perts")
slicepoints.add_task("integ(integ( (by - integ(integ( by, 'y'), 'z'))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="be_y_perts")

slicepoints.add_task("integ(integ( (vz - integ(integ( vz, 'y'), 'z'))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="ke_z_perts")
slicepoints.add_task("integ(integ( (bz - integ(integ( bz, 'y'), 'z'))**2, 'y'), 'z') / (Lx**2 * ar**2)", name="be_z_perts")
...
# solver.stop_wall_time = 3.25*60.*60.
solver.stop_wall_time = 1.*60.
