...
SUFF="viff2en3_R0p6_Bsin2x_N256_test"
DIFF=0.002
MPIPROC=256
...
mpiexec_mpt -np 1 python3 plot_be_dirs.py slicepoints_${SUFF}/*.h5 --suffix=$SUFF
mpiexec_mpt -np 1 python3 plot_ke_dirs.py slicepoints_${SUFF}/*.h5 --suffix=$SUFF
